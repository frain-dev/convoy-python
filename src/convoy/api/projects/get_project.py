...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[GetProjectResponse200 | GetProjectResponse400 | GetProjectResponse401 | GetProjectResponse404]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        GetProjectResponse200 | GetProjectResponse400 | GetProjectResponse401 | GetProjectResponse404
    """
