...
from ...models.get_event_deliveries_paged_direction import (
    GetEventDeliveriesPagedDirection,
)
from ...models.get_event_deliveries_paged_response_200 import (
    GetEventDeliveriesPagedResponse200,
)
from ...models.get_event_deliveries_paged_response_400 import (
    GetEventDeliveriesPagedResponse400,
)
from ...models.get_event_deliveries_paged_response_401 import (
...
def _get_kwargs(
    project_id: str,
    *,
    direction: GetEventDeliveriesPagedDirection | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/projects/{project_id}/eventdeliveries".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetEventDeliveriesPagedResponse200.from_dict(response.json())

        return response_200

    if response.status_code == 400:
        response_400 = GetEventDeliveriesPagedResponse400.from_dict(response.json())

        return response_400

    if response.status_code == 401:
        response_401 = GetEventDeliveriesPagedResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 404:
        response_404 = GetEventDeliveriesPagedResponse404.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        project_id (str):
        direction (GetEventDeliveriesPagedDirection | Unset):
        end_date (str | Unset):
