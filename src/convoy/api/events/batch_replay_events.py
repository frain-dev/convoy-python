...
from ...models.batch_replay_events_direction import BatchReplayEventsDirection
from ...models.batch_replay_events_response_200 import BatchReplayEventsResponse200
from ...models.batch_replay_events_response_400 import BatchReplayEventsResponse400
from ...models.batch_replay_events_response_401 import BatchReplayEventsResponse401
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/projects/{project_id}/events/batchreplay".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = BatchReplayEventsResponse200.from_dict(response.json())

        return response_200

    if response.status_code == 400:
        response_400 = BatchReplayEventsResponse400.from_dict(response.json())

        return response_400

    if response.status_code == 401:
        response_401 = BatchReplayEventsResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 404:
        response_404 = BatchReplayEventsResponse404.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[BatchReplayEventsResponse200 | BatchReplayEventsResponse400 | BatchReplayEventsResponse401 | BatchReplayEventsResponse404]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        BatchReplayEventsResponse200 | BatchReplayEventsResponse400 | BatchReplayEventsResponse401 | BatchReplayEventsResponse404
    """
