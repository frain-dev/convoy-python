...
from ...models.count_affected_events_direction import CountAffectedEventsDirection
from ...models.count_affected_events_response_200 import CountAffectedEventsResponse200
from ...models.count_affected_events_response_400 import CountAffectedEventsResponse400
from ...models.count_affected_events_response_401 import CountAffectedEventsResponse401
from ...models.count_affected_events_response_404 import CountAffectedEventsResponse404
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/projects/{project_id}/events/countbatchreplayevents".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CountAffectedEventsResponse200.from_dict(response.json())

        return response_200

    if response.status_code == 400:
        response_400 = CountAffectedEventsResponse400.from_dict(response.json())

        return response_400

    if response.status_code == 401:
        response_401 = CountAffectedEventsResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 404:
        response_404 = CountAffectedEventsResponse404.from_dict(response.json())
