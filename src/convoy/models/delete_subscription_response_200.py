...
T = TypeVar("T", bound="DeleteSubscriptionResponse200")


@_attrs_define
class DeleteSubscriptionResponse200:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_subscription_response_200 = cls(
            message=message,
            status=status,
            data=data,
        )

        delete_subscription_response_200.additional_properties = d
