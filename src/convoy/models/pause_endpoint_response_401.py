...
T = TypeVar("T", bound="PauseEndpointResponse401")


@_attrs_define
class PauseEndpointResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pause_endpoint_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        pause_endpoint_response_401.additional_properties = d
