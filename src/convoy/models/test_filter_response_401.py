...
T = TypeVar("T", bound="TestFilterResponse401")


@_attrs_define
class TestFilterResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        test_filter_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        test_filter_response_401.additional_properties = d
        return test_filter_response_401
