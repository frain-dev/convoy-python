...
T = TypeVar("T", bound="TestSubscriptionFilterResponse404")


@_attrs_define
class TestSubscriptionFilterResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        test_subscription_filter_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        test_subscription_filter_response_404.additional_properties = d
