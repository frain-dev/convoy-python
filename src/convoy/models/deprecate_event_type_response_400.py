...
T = TypeVar("T", bound="DeprecateEventTypeResponse400")


@_attrs_define
class DeprecateEventTypeResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deprecate_event_type_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        deprecate_event_type_response_400.additional_properties = d
        return deprecate_event_type_response_400
