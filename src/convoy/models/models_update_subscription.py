...
if TYPE_CHECKING:
    ...
    from ..models.models_retry_configuration import ModelsRetryConfiguration


T = TypeVar("T", bound="ModelsUpdateSubscription")
...
class ModelsUpdateSubscription:
    ...
    Attributes:
        ...
        retry_config (ModelsRetryConfiguration | Unset):
    ...
    retry_config: ModelsRetryConfiguration | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_retry_config, Unset):
            ...
            retry_config = ModelsRetryConfiguration.from_dict(_retry_config)

        source_id = d.pop("source_id", UNSET)

        models_update_subscription = cls(
        ...
        models_update_subscription.additional_properties = d
        return models_update_subscription
