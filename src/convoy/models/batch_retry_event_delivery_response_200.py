...
T = TypeVar("T", bound="BatchRetryEventDeliveryResponse200")


@_attrs_define
class BatchRetryEventDeliveryResponse200:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_retry_event_delivery_response_200 = cls(
            message=message,
            status=status,
            data=data,
        )

        batch_retry_event_delivery_response_200.additional_properties = d
