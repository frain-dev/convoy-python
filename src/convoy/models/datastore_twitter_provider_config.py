...
class DatastoreTwitterProviderConfig:
    """
    Attributes:
        crc_verified_at (None | str | Unset):
    """

    crc_verified_at: None | str | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        crc_verified_at: None | str | Unset
        if isinstance(self.crc_verified_at, Unset):
            crc_verified_at = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_crc_verified_at(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        crc_verified_at = _parse_crc_verified_at(d.pop("crc_verified_at", UNSET))
