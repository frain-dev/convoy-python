...
T = TypeVar("T", bound="BulkOnboardResponse401")


@_attrs_define
class BulkOnboardResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_onboard_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        bulk_onboard_response_401.additional_properties = d
        return bulk_onboard_response_401
