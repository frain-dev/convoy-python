...
T = TypeVar("T", bound="ModelsOAuth2SigningKey")
...
class ModelsOAuth2SigningKey:
    ...
    Attributes:
        ...
        d (str | Unset): Private key (EC) or private exponent (RSA)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        models_o_auth_2_signing_key = cls(
            crv=crv,
            d=d,
            dp=dp,
            dq=dq,
        ...
        models_o_auth_2_signing_key.additional_properties = d
        return models_o_auth_2_signing_key
