...
T = TypeVar("T", bound="ReplayEndpointEventResponse400")


@_attrs_define
class ReplayEndpointEventResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replay_endpoint_event_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        replay_endpoint_event_response_400.additional_properties = d
