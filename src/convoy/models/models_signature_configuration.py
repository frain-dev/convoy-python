...
if TYPE_CHECKING:
    from ..models.models_signature_version import ModelsSignatureVersion


T = TypeVar("T", bound="ModelsSignatureConfiguration")


@_attrs_define
class ModelsSignatureConfiguration:
    """
    Attributes:
        header (ConfigSignatureHeaderProvider | Unset):
        versions (list[ModelsSignatureVersion] | Unset):
    """

    header: ConfigSignatureHeaderProvider | Unset = UNSET
    versions: list[ModelsSignatureVersion] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _versions is not UNSET:
            ...
            for versions_item_data in _versions:
                versions_item = ModelsSignatureVersion.from_dict(versions_item_data)

                versions.append(versions_item)

        models_signature_configuration = cls(
            header=header,
            versions=versions,
        )
