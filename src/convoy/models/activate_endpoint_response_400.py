...
T = TypeVar("T", bound="ActivateEndpointResponse400")


@_attrs_define
class ActivateEndpointResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activate_endpoint_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        activate_endpoint_response_400.additional_properties = d
