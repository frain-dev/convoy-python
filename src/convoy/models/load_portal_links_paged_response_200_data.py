...
if TYPE_CHECKING:
    ...
    from ..models.datastore_portal_link_response import DatastorePortalLinkResponse


T = TypeVar("T", bound="LoadPortalLinksPagedResponse200Data")


@_attrs_define
class LoadPortalLinksPagedResponse200Data:
    """
    Attributes:
        content (list[DatastorePortalLinkResponse] | Unset):
        pagination (DatastorePaginationData | None | Unset):
    """

    content: list[DatastorePortalLinkResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = DatastorePortalLinkResponse.from_dict(content_item_data)
        ...
        load_portal_links_paged_response_200_data = cls(
            content=content,
            pagination=pagination,
        )

        load_portal_links_paged_response_200_data.additional_properties = d
        return load_portal_links_paged_response_200_data
