...
T = TypeVar("T", bound="ReplayEndpointEventResponse404")


@_attrs_define
class ReplayEndpointEventResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replay_endpoint_event_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        replay_endpoint_event_response_404.additional_properties = d
        return replay_endpoint_event_response_404
