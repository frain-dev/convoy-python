...
T = TypeVar("T", bound="GetMetaEventsPagedResponse200Data")


@_attrs_define
class GetMetaEventsPagedResponse200Data:
    """
    Attributes:
        content (list[ModelsMetaEventResponse] | Unset):
        pagination (DatastorePaginationData | None | Unset):
    """

    content: list[ModelsMetaEventResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ModelsMetaEventResponse.from_dict(content_item_data)
        ...
        get_meta_events_paged_response_200_data = cls(
            content=content,
            pagination=pagination,
        )

        get_meta_events_paged_response_200_data.additional_properties = d
