...
T = TypeVar("T", bound="BatchReplayEventsResponse401")


@_attrs_define
class BatchReplayEventsResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_replay_events_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        batch_replay_events_response_401.additional_properties = d
