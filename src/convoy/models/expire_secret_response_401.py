...
T = TypeVar("T", bound="ExpireSecretResponse401")


@_attrs_define
class ExpireSecretResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        expire_secret_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        expire_secret_response_401.additional_properties = d
