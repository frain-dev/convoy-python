...
T = TypeVar("T", bound="ForceResendEventDeliveriesResponse400")


@_attrs_define
class ForceResendEventDeliveriesResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        force_resend_event_deliveries_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        force_resend_event_deliveries_response_400.additional_properties = d
