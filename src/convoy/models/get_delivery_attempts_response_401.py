...
T = TypeVar("T", bound="GetDeliveryAttemptsResponse401")
...
class GetDeliveryAttemptsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_delivery_attempts_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_delivery_attempts_response_401.additional_properties = d
        return get_delivery_attempts_response_401
