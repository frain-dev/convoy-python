...
T = TypeVar("T", bound="DeleteSubscriptionResponse404")


@_attrs_define
class DeleteSubscriptionResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_subscription_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        delete_subscription_response_404.additional_properties = d
        return delete_subscription_response_404
