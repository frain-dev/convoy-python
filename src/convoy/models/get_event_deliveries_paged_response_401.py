...
T = TypeVar("T", bound="GetEventDeliveriesPagedResponse401")


@_attrs_define
class GetEventDeliveriesPagedResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_event_deliveries_paged_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_event_deliveries_paged_response_401.additional_properties = d
