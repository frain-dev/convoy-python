...
T = TypeVar("T", bound="CreateSubscriptionResponse401")


@_attrs_define
class CreateSubscriptionResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_subscription_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_subscription_response_401.additional_properties = d
