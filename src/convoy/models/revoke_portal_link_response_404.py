...
T = TypeVar("T", bound="RevokePortalLinkResponse404")


@_attrs_define
class RevokePortalLinkResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revoke_portal_link_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        revoke_portal_link_response_404.additional_properties = d
