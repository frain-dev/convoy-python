...
T = TypeVar("T", bound="BulkUpdateFiltersResponse404")


@_attrs_define
class BulkUpdateFiltersResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_update_filters_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        bulk_update_filters_response_404.additional_properties = d
        return bulk_update_filters_response_404
