...
T = TypeVar("T", bound="GetDeliveryAttemptResponse400")


@_attrs_define
class GetDeliveryAttemptResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_delivery_attempt_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_delivery_attempt_response_400.additional_properties = d
        return get_delivery_attempt_response_400
