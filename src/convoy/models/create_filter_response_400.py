...
T = TypeVar("T", bound="CreateFilterResponse400")


@_attrs_define
class CreateFilterResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_filter_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_filter_response_400.additional_properties = d
