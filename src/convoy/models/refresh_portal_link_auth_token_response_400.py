...
T = TypeVar("T", bound="RefreshPortalLinkAuthTokenResponse400")


@_attrs_define
class RefreshPortalLinkAuthTokenResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        refresh_portal_link_auth_token_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        refresh_portal_link_auth_token_response_400.additional_properties = d
        return refresh_portal_link_auth_token_response_400
