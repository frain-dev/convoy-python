...
T = TypeVar("T", bound="PostV1ProjectsProjectIDSourcesTestFunctionResponse404")


@_attrs_define
class PostV1ProjectsProjectIDSourcesTestFunctionResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_v1_projects_project_id_sources_test_function_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        post_v1_projects_project_id_sources_test_function_response_404.additional_properties = d
