...
T = TypeVar("T", bound="GetFiltersResponse404")


@_attrs_define
class GetFiltersResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_filters_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_filters_response_404.additional_properties = d
        return get_filters_response_404
