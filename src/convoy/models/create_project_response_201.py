...
if TYPE_CHECKING:
    from ..models.models_create_project_response import ModelsCreateProjectResponse
...
class CreateProjectResponse201:
    ...
    Attributes:
        message (str | Unset):
        status (bool | Unset):
        data (ModelsCreateProjectResponse | Unset):
    """

    message: str | Unset = UNSET
    status: bool | Unset = UNSET
    data: ModelsCreateProjectResponse | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = ModelsCreateProjectResponse.from_dict(_data)
