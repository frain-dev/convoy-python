...
T = TypeVar("T", bound="ImportOpenApiSpecResponse200")


@_attrs_define
class ImportOpenApiSpecResponse200:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_open_api_spec_response_200 = cls(
            message=message,
            status=status,
            data=data,
        )

        import_open_api_spec_response_200.additional_properties = d
        return import_open_api_spec_response_200
