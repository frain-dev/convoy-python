...
T = TypeVar("T", bound="ImportOpenApiSpecResponse400")


@_attrs_define
class ImportOpenApiSpecResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_open_api_spec_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        import_open_api_spec_response_400.additional_properties = d
