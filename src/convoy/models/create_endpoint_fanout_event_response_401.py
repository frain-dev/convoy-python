...
T = TypeVar("T", bound="CreateEndpointFanoutEventResponse401")


@_attrs_define
class CreateEndpointFanoutEventResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_endpoint_fanout_event_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_endpoint_fanout_event_response_401.additional_properties = d
