...
T = TypeVar("T", bound="RevokePortalLinkResponse200")


@_attrs_define
class RevokePortalLinkResponse200:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revoke_portal_link_response_200 = cls(
            message=message,
            status=status,
            data=data,
        )

        revoke_portal_link_response_200.additional_properties = d
        return revoke_portal_link_response_200
