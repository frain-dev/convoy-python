...
T = TypeVar("T", bound="DatastoreMtlsClientCert")
...
class DatastoreMtlsClientCert:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        datastore_mtls_client_cert = cls(
            client_cert=client_cert,
            client_key=client_key,
        )

        datastore_mtls_client_cert.additional_properties = d
        return datastore_mtls_client_cert
