...
T = TypeVar("T", bound="GetEventsPagedResponse403")


@_attrs_define
class GetEventsPagedResponse403:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_events_paged_response_403 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_events_paged_response_403.additional_properties = d
        return get_events_paged_response_403
