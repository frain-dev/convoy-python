...
if TYPE_CHECKING:
    ...
    from ..models.models_event_delivery_response import ModelsEventDeliveryResponse
...
@_attrs_define
class GetEventDeliveriesPagedResponse200Data:
    """
    Attributes:
        content (list[ModelsEventDeliveryResponse] | Unset):
        pagination (DatastorePaginationData | None | Unset):
    """

    content: list[ModelsEventDeliveryResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ModelsEventDeliveryResponse.from_dict(content_item_data)
        ...
        get_event_deliveries_paged_response_200_data = cls(
            content=content,
            pagination=pagination,
        )

        get_event_deliveries_paged_response_200_data.additional_properties = d
        return get_event_deliveries_paged_response_200_data
