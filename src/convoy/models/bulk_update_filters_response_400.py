...
T = TypeVar("T", bound="BulkUpdateFiltersResponse400")


@_attrs_define
class BulkUpdateFiltersResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_update_filters_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        bulk_update_filters_response_400.additional_properties = d
