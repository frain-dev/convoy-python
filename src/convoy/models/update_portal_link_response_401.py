...
T = TypeVar("T", bound="UpdatePortalLinkResponse401")


@_attrs_define
class UpdatePortalLinkResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_portal_link_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        update_portal_link_response_401.additional_properties = d
        return update_portal_link_response_401
