...
T = TypeVar("T", bound="ResendEventDeliveryResponse404")
...
class ResendEventDeliveryResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resend_event_delivery_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        resend_event_delivery_response_404.additional_properties = d
        return resend_event_delivery_response_404
