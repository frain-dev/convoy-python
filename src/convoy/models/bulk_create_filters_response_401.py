...
T = TypeVar("T", bound="BulkCreateFiltersResponse401")


@_attrs_define
class BulkCreateFiltersResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_create_filters_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        bulk_create_filters_response_401.additional_properties = d
