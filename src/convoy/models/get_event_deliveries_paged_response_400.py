...
T = TypeVar("T", bound="GetEventDeliveriesPagedResponse400")


@_attrs_define
class GetEventDeliveriesPagedResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_event_deliveries_paged_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_event_deliveries_paged_response_400.additional_properties = d
