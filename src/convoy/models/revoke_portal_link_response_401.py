...
T = TypeVar("T", bound="RevokePortalLinkResponse401")


@_attrs_define
class RevokePortalLinkResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revoke_portal_link_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        revoke_portal_link_response_401.additional_properties = d
        return revoke_portal_link_response_401
