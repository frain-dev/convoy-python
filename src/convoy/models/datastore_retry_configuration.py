...
T = TypeVar("T", bound="DatastoreRetryConfiguration")
...
class DatastoreRetryConfiguration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        datastore_retry_configuration = cls(
            duration=duration,
            retry_count=retry_count,
            type_=type_,
        )

        datastore_retry_configuration.additional_properties = d
        return datastore_retry_configuration
