...
T = TypeVar("T", bound="GetEndpointPeriodFailureRatesResponse404")


@_attrs_define
class GetEndpointPeriodFailureRatesResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_endpoint_period_failure_rates_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_endpoint_period_failure_rates_response_404.additional_properties = d
        return get_endpoint_period_failure_rates_response_404
