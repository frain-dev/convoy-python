...
if TYPE_CHECKING:
    from ..models.models_o_auth_2_field_mapping import ModelsOAuth2FieldMapping
    from ..models.models_o_auth_2_signing_key import ModelsOAuth2SigningKey


T = TypeVar("T", bound="ModelsOAuth2")
...
class ModelsOAuth2:
    ...
    Attributes:
        audience (str | Unset):
        authentication_type (str | Unset):
        client_id (str | Unset):
        client_secret (str | Unset):
        expiry_time_unit (str | Unset): Expiry time unit (seconds, milliseconds, minutes, hours)
        field_mapping (ModelsOAuth2FieldMapping | Unset):
        grant_type (str | Unset):
        issuer (str | Unset):
        scope (str | Unset):
        signing_algorithm (str | Unset):
        signing_key (ModelsOAuth2SigningKey | Unset):
        subject (str | Unset):
        url (str | Unset):
    """
    ...
    field_mapping: ModelsOAuth2FieldMapping | Unset = UNSET
    grant_type: str | Unset = UNSET
    issuer: str | Unset = UNSET
    scope: str | Unset = UNSET
    signing_algorithm: str | Unset = UNSET
    signing_key: ModelsOAuth2SigningKey | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        expiry_time_unit = self.expiry_time_unit
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        authentication_type = d.pop("authentication_type", UNSET)

        client_id = d.pop("client_id", UNSET)

        client_secret = d.pop("client_secret", UNSET)

        expiry_time_unit = d.pop("expiry_time_unit", UNSET)
        ...
        if isinstance(_field_mapping, Unset):
            ...
            field_mapping = ModelsOAuth2FieldMapping.from_dict(_field_mapping)
        ...
        if isinstance(_signing_key, Unset):
            ...
            signing_key = ModelsOAuth2SigningKey.from_dict(_signing_key)
        ...
        models_o_auth_2.additional_properties = d
        return models_o_auth_2
