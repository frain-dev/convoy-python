...
T = TypeVar("T", bound="CreateBroadcastEventResponse400")


@_attrs_define
class CreateBroadcastEventResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_broadcast_event_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_broadcast_event_response_400.additional_properties = d
        return create_broadcast_event_response_400
