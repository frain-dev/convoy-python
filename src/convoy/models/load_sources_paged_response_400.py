...
T = TypeVar("T", bound="LoadSourcesPagedResponse400")


@_attrs_define
class LoadSourcesPagedResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_sources_paged_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        load_sources_paged_response_400.additional_properties = d
