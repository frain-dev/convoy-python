...
T = TypeVar("T", bound="TestSubscriptionFilterResponse400")


@_attrs_define
class TestSubscriptionFilterResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        test_subscription_filter_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        test_subscription_filter_response_400.additional_properties = d
        return test_subscription_filter_response_400
