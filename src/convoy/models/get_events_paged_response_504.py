...
T = TypeVar("T", bound="GetEventsPagedResponse504")
...
class GetEventsPagedResponse504:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_events_paged_response_504 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_events_paged_response_504.additional_properties = d
        return get_events_paged_response_504
