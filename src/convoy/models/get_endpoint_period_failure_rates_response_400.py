...
T = TypeVar("T", bound="GetEndpointPeriodFailureRatesResponse400")


@_attrs_define
class GetEndpointPeriodFailureRatesResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_endpoint_period_failure_rates_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_endpoint_period_failure_rates_response_400.additional_properties = d
        return get_endpoint_period_failure_rates_response_400
