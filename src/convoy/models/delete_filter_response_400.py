...
T = TypeVar("T", bound="DeleteFilterResponse400")


@_attrs_define
class DeleteFilterResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_filter_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        delete_filter_response_400.additional_properties = d
        return delete_filter_response_400
