...
T = TypeVar("T", bound="ToggleSubscriptionStatusResponse404")


@_attrs_define
class ToggleSubscriptionStatusResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        toggle_subscription_status_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        toggle_subscription_status_response_404.additional_properties = d
        return toggle_subscription_status_response_404
