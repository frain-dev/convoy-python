...
T = TypeVar("T", bound="CreateDynamicEventResponse404")


@_attrs_define
class CreateDynamicEventResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_dynamic_event_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_dynamic_event_response_404.additional_properties = d
        return create_dynamic_event_response_404
