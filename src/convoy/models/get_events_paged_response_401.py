...
T = TypeVar("T", bound="GetEventsPagedResponse401")


@_attrs_define
class GetEventsPagedResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_events_paged_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_events_paged_response_401.additional_properties = d
