...
T = TypeVar("T", bound="ActivateEndpointResponse401")


@_attrs_define
class ActivateEndpointResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activate_endpoint_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        activate_endpoint_response_401.additional_properties = d
        return activate_endpoint_response_401
