...
T = TypeVar("T", bound="CreateFilterResponse404")


@_attrs_define
class CreateFilterResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_filter_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_filter_response_404.additional_properties = d
