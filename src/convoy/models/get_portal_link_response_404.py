...
T = TypeVar("T", bound="GetPortalLinkResponse404")


@_attrs_define
class GetPortalLinkResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_portal_link_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_portal_link_response_404.additional_properties = d
