...
T = TypeVar("T", bound="ModelsCreateFilterRequest")
...
class ModelsCreateFilterRequest:
    """
    Attributes:
        event_type (str): Type of event this filter applies to (required)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        models_create_filter_request = cls(
            event_type=event_type,
            body=body,
        ...
        models_create_filter_request.additional_properties = d
        return models_create_filter_request
