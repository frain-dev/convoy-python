...
T = TypeVar("T", bound="GetProjectsResponse401")


@_attrs_define
class GetProjectsResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_projects_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_projects_response_401.additional_properties = d
        return get_projects_response_401
