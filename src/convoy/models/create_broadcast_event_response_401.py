...
T = TypeVar("T", bound="CreateBroadcastEventResponse401")


@_attrs_define
class CreateBroadcastEventResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_broadcast_event_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_broadcast_event_response_401.additional_properties = d
        return create_broadcast_event_response_401
