...
if TYPE_CHECKING:
    ...
    from ..models.models_event_response_data import ModelsEventResponseData
...
class ModelsEventResponse:
    ...
    Attributes:
        ...
        data (ModelsEventResponseData | Unset): Data is an arbitrary JSON value that gets sent as the body of the
    ...
    data: ModelsEventResponseData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: ModelsEventResponseData | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = ModelsEventResponseData.from_dict(_data)
