...
T = TypeVar("T", bound="ForceResendEventDeliveriesResponse404")


@_attrs_define
class ForceResendEventDeliveriesResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        force_resend_event_deliveries_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        force_resend_event_deliveries_response_404.additional_properties = d
        return force_resend_event_deliveries_response_404
