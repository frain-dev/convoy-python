...
T = TypeVar("T", bound="DeleteEndpointResponse401")


@_attrs_define
class DeleteEndpointResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_endpoint_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        delete_endpoint_response_401.additional_properties = d
