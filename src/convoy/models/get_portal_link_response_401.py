...
T = TypeVar("T", bound="GetPortalLinkResponse401")


@_attrs_define
class GetPortalLinkResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_portal_link_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_portal_link_response_401.additional_properties = d
        return get_portal_link_response_401
