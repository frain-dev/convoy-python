...
T = TypeVar("T", bound="PostV1ProjectsProjectIDSourcesTestFunctionResponse401")
...
class PostV1ProjectsProjectIDSourcesTestFunctionResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_v1_projects_project_id_sources_test_function_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        post_v1_projects_project_id_sources_test_function_response_401.additional_properties = d
