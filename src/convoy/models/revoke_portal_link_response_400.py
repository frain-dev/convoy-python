...
T = TypeVar("T", bound="RevokePortalLinkResponse400")


@_attrs_define
class RevokePortalLinkResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revoke_portal_link_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        revoke_portal_link_response_400.additional_properties = d
