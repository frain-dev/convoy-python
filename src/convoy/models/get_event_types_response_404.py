...
T = TypeVar("T", bound="GetEventTypesResponse404")


@_attrs_define
class GetEventTypesResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_event_types_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_event_types_response_404.additional_properties = d
