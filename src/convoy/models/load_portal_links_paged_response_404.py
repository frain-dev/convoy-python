...
T = TypeVar("T", bound="LoadPortalLinksPagedResponse404")


@_attrs_define
class LoadPortalLinksPagedResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_portal_links_paged_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        load_portal_links_paged_response_404.additional_properties = d
        return load_portal_links_paged_response_404
