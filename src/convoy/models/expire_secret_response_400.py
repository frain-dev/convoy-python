...
T = TypeVar("T", bound="ExpireSecretResponse400")


@_attrs_define
class ExpireSecretResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        expire_secret_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        expire_secret_response_400.additional_properties = d
        return expire_secret_response_400
