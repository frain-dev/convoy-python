...
T = TypeVar("T", bound="CreateFilterResponse401")


@_attrs_define
class CreateFilterResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_filter_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_filter_response_401.additional_properties = d
        return create_filter_response_401
