...
T = TypeVar("T", bound="CreateProjectResponse402")


@_attrs_define
class CreateProjectResponse402:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_project_response_402 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_project_response_402.additional_properties = d
        return create_project_response_402
