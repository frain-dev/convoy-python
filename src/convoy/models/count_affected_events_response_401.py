...
T = TypeVar("T", bound="CountAffectedEventsResponse401")


@_attrs_define
class CountAffectedEventsResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        count_affected_events_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        count_affected_events_response_401.additional_properties = d
        return count_affected_events_response_401
