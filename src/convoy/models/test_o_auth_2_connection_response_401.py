...
T = TypeVar("T", bound="TestOAuth2ConnectionResponse401")


@_attrs_define
class TestOAuth2ConnectionResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        test_o_auth_2_connection_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        test_o_auth_2_connection_response_401.additional_properties = d
        return test_o_auth_2_connection_response_401
