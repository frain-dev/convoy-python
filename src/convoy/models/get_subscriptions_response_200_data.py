...
if TYPE_CHECKING:
    ...
    from ..models.models_subscription_response import ModelsSubscriptionResponse


T = TypeVar("T", bound="GetSubscriptionsResponse200Data")


@_attrs_define
class GetSubscriptionsResponse200Data:
    """
    Attributes:
        content (list[ModelsSubscriptionResponse] | Unset):
        pagination (DatastorePaginationData | None | Unset):
    """

    content: list[ModelsSubscriptionResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ModelsSubscriptionResponse.from_dict(content_item_data)
        ...
        get_subscriptions_response_200_data = cls(
            content=content,
            pagination=pagination,
        )

        get_subscriptions_response_200_data.additional_properties = d
        return get_subscriptions_response_200_data
