...
if TYPE_CHECKING:
    from ..models.models_update_event_type_json_schema_type_0 import (
...
class ModelsUpdateEventType:
    ...
    Attributes:
        ...
        json_schema (ModelsUpdateEventTypeJsonSchemaType0 | None | Unset): JSONSchema is the JSON structure of the event
            type
    """

    category: str | Unset = UNSET
    description: str | Unset = UNSET
    json_schema: ModelsUpdateEventTypeJsonSchemaType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.json_schema, Unset):
            json_schema = UNSET
        elif isinstance(self.json_schema, ModelsUpdateEventTypeJsonSchemaType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_json_schema(
            data: object,
        ) -> ModelsUpdateEventTypeJsonSchemaType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                json_schema_type_0 = ModelsUpdateEventTypeJsonSchemaType0.from_dict(
                    data
                )
                ...
                pass
            return cast(ModelsUpdateEventTypeJsonSchemaType0 | None | Unset, data)
