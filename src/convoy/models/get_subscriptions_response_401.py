...
T = TypeVar("T", bound="GetSubscriptionsResponse401")


@_attrs_define
class GetSubscriptionsResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_subscriptions_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_subscriptions_response_401.additional_properties = d
