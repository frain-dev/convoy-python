...
T = TypeVar("T", bound="DeleteEndpointResponse200")


@_attrs_define
class DeleteEndpointResponse200:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_endpoint_response_200 = cls(
            message=message,
            status=status,
            data=data,
        )

        delete_endpoint_response_200.additional_properties = d
        return delete_endpoint_response_200
