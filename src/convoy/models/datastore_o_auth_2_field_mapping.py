...
T = TypeVar("T", bound="DatastoreOAuth2FieldMapping")
...
class DatastoreOAuth2FieldMapping:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        datastore_o_auth_2_field_mapping = cls(
            access_token=access_token,
            expires_in=expires_in,
            token_type=token_type,
        )

        datastore_o_auth_2_field_mapping.additional_properties = d
        return datastore_o_auth_2_field_mapping
