...
T = TypeVar("T", bound="GetEndpointsResponse401")


@_attrs_define
class GetEndpointsResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_endpoints_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_endpoints_response_401.additional_properties = d
