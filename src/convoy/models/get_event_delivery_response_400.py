...
T = TypeVar("T", bound="GetEventDeliveryResponse400")


@_attrs_define
class GetEventDeliveryResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_event_delivery_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        get_event_delivery_response_400.additional_properties = d
        return get_event_delivery_response_400
