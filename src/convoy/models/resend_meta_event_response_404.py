...
T = TypeVar("T", bound="ResendMetaEventResponse404")


@_attrs_define
class ResendMetaEventResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resend_meta_event_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        resend_meta_event_response_404.additional_properties = d
        return resend_meta_event_response_404
