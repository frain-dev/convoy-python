...
T = TypeVar("T", bound="UpdatePortalLinkResponse400")


@_attrs_define
class UpdatePortalLinkResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_portal_link_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        update_portal_link_response_400.additional_properties = d
        return update_portal_link_response_400
