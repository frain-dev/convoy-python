...
T = TypeVar("T", bound="CountAffectedEventsResponse400")


@_attrs_define
class CountAffectedEventsResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        count_affected_events_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        count_affected_events_response_400.additional_properties = d
