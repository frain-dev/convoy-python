...
T = TypeVar("T", bound="ActivateEndpointResponse404")


@_attrs_define
class ActivateEndpointResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activate_endpoint_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        activate_endpoint_response_404.additional_properties = d
        return activate_endpoint_response_404
