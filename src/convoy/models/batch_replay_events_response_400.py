...
T = TypeVar("T", bound="BatchReplayEventsResponse400")


@_attrs_define
class BatchReplayEventsResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_replay_events_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        batch_replay_events_response_400.additional_properties = d
        return batch_replay_events_response_400
