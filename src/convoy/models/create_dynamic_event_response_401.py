...
T = TypeVar("T", bound="CreateDynamicEventResponse401")
...
class CreateDynamicEventResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_dynamic_event_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_dynamic_event_response_401.additional_properties = d
        return create_dynamic_event_response_401
