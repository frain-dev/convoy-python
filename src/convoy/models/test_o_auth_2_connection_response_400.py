...
T = TypeVar("T", bound="TestOAuth2ConnectionResponse400")


@_attrs_define
class TestOAuth2ConnectionResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        test_o_auth_2_connection_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        test_o_auth_2_connection_response_400.additional_properties = d
        return test_o_auth_2_connection_response_400
