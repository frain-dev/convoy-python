...
T = TypeVar("T", bound="PauseEndpointResponse404")


@_attrs_define
class PauseEndpointResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pause_endpoint_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        pause_endpoint_response_404.additional_properties = d
        return pause_endpoint_response_404
