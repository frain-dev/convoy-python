...
T = TypeVar("T", bound="DatastoreSSLConfiguration")


@_attrs_define
class DatastoreSSLConfiguration:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        datastore_ssl_configuration = cls(
            enforce_secure_endpoints=enforce_secure_endpoints,
        )

        datastore_ssl_configuration.additional_properties = d
        return datastore_ssl_configuration
