...
if TYPE_CHECKING:
    ...
    from ..models.models_source_response import ModelsSourceResponse


T = TypeVar("T", bound="LoadSourcesPagedResponse200Data")


@_attrs_define
class LoadSourcesPagedResponse200Data:
    """
    Attributes:
        content (list[ModelsSourceResponse] | Unset):
        pagination (DatastorePaginationData | None | Unset):
    """

    content: list[ModelsSourceResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ModelsSourceResponse.from_dict(content_item_data)
        ...
        load_sources_paged_response_200_data = cls(
            content=content,
            pagination=pagination,
        )

        load_sources_paged_response_200_data.additional_properties = d
        return load_sources_paged_response_200_data
