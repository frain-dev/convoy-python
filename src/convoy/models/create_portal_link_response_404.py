...
T = TypeVar("T", bound="CreatePortalLinkResponse404")


@_attrs_define
class CreatePortalLinkResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_portal_link_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_portal_link_response_404.additional_properties = d
