...
T = TypeVar("T", bound="DeleteFilterResponse404")


@_attrs_define
class DeleteFilterResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_filter_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        delete_filter_response_404.additional_properties = d
        return delete_filter_response_404
