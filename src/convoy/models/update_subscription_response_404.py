...
T = TypeVar("T", bound="UpdateSubscriptionResponse404")


@_attrs_define
class UpdateSubscriptionResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_subscription_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        update_subscription_response_404.additional_properties = d
