...
T = TypeVar("T", bound="TestSubscriptionFilterResponse401")


@_attrs_define
class TestSubscriptionFilterResponse401:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        test_subscription_filter_response_401 = cls(
            message=message,
            status=status,
            data=data,
        )

        test_subscription_filter_response_401.additional_properties = d
        return test_subscription_filter_response_401
