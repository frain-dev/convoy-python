...
T = TypeVar("T", bound="CreateEndpointEventResponse404")


@_attrs_define
class CreateEndpointEventResponse404:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_endpoint_event_response_404 = cls(
            message=message,
            status=status,
            data=data,
        )

        create_endpoint_event_response_404.additional_properties = d
