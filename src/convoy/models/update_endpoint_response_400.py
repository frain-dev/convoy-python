...
T = TypeVar("T", bound="UpdateEndpointResponse400")


@_attrs_define
class UpdateEndpointResponse400:
    """
    Attributes:
        message (str | Unset):
        status (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_endpoint_response_400 = cls(
            message=message,
            status=status,
            data=data,
        )

        update_endpoint_response_400.additional_properties = d
